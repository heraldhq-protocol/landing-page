...
- **Email**: [hello@useherald.xyz](mailto:hello@useherald.xyz) — general inquiries and support.
- **Enterprise partners**: contact your dedicated support channel on Slack or Discord.
- **Open-source contributors**: open a [GitHub Issue](https://github.com/heraldhq-protocol/herald-sdk-ts/issues).
- **Dashboard**: manage your integration at [app.useherald.xyz](https://app.useherald.xyz).
