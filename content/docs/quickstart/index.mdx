...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
  ...
  <div className="border rounded-lg p-4">
    ...
    [View Protocol Specs](/docs/specifications/specifications)
  </div>
  <div className="border rounded-lg p-4">
    ### 🛡️ System Architect
  ...
  <div className="border rounded-lg p-4">
    ### 💻 CLI / Automation
    Send notifications and manage your protocol from the terminal or CI/CD pipelines. Agent-first design.
