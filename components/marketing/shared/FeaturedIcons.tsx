...
export default function FeatureIcon({ Icon }: { Icon: LucideIcon }) {
  return (
    <div className="relative group">
      ...
      <div className="relative flex items-center justify-center w-12 h-12 rounded-xl bg-card-2 border border-border-alt group-hover:border-teal/50 transition-colors">
