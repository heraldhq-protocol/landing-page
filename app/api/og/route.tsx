...
export async function GET(request: Request) {
  ...
  const title = searchParams.get("title") || "Privacy-Preserving";
  const subtitle = searchParams.get("subtitle") || "DeFi Notifications";
  const description = searchParams.get("description") || "Send alerts to your users without ever storing their contact info. Built on Solana.";
